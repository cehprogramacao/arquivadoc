    ...
    return (
        ...
        >
            <Box sx={{
                ...
                {/* Info Footer - Show permissions status */}
                {/* {(editPerm === 0 || deletePerm === 0) && (
                    <Box sx={{ 
                        ...
                        <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.75rem' }}>
                            {editPerm === 0 && deletePerm === 0 && "Modo somente leitura"}
                            {editPerm === 0 && deletePerm === 1 && "Edição não permitida"}
                            {editPerm === 1 && deletePerm === 0 && "Exclusão não permitida"}
                        </Typography>
                    </Box>
                )} */}
            </Box>
