...
export const CadastroNotasInventario = ({ onClose, onClickPartes }) => {
  ...
  const tipos_escrituras = ['Inventário e Partilha','Inventário e Sobrepartilhao'];
