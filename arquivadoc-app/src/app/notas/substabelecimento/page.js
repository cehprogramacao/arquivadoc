...
import { CadastroNotasSubstabelecimento } from "@/Components/Modals/ModalCadastroNotasSubs"
    ...
    return (
        ...
        >
            ...
            <Drawer anchor="left" open={openModalCadastro} onClose={handleCloseModalCadastro}>
                <CadastroNotasSubstabelecimento onClose={handleCloseModalCadastro} onClickPartes={handleOpenModalCadastroPartes} />
            </Drawer>
